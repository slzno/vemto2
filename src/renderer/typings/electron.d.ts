...
export default interface ElectronApi {
    ...
    readPublishedTemplateFile: (path: string) => Promise<string>,
    readDefaultTemplateFile: (path: string) => Promise<string>,
    ...
    upgradePublishedTemplate: (path: string) => Promise<void>,
    upgradeCustomTemplate: (path: string) => Promise<void>,
