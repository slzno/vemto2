...
<template>
    ...
    >
        ...
        <div
            id="entity2"
            class="entity cursor-move absolute shadow-lg p-4 rounded-lg bg-white"
            style="min-width: 270px; top: 450px; left: 950px"
        >
            ...
            <div class="mt-4 font-mono">
                ...
                <div class="w-full flex items-center">
                    ...
                    >
                        <div
                            class="w-2 h-2 mr-2 rounded-full bg-teal-400"
                        ></div>
                        user_id
                    </span>
                    <span
        ...
        <div
            id="entity3"
            class="entity cursor-move absolute shadow-lg p-4 rounded-lg bg-white"
            style="min-width: 270px; top: 110px; left: 1050px"
        >
            <span class="title w-full font-semibold text-lg text-slate-500"
                >user_log</span
            >
        ...
        <div
            id="entity4"
            class="entity cursor-move absolute shadow-lg p-4 rounded-lg bg-white"
            style="min-width: 270px; top: 500px; left: 50px"
        >
