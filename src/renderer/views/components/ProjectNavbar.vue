...
<template>
    <nav class="w-20 h-full flex flex-col items-center justify-between bg-white dark:bg-slate-900 border-r-2 border-slate-100 dark:border-slate-800">
        <ul>
            ...
            <li
                class="w-full h-12 flex justify-center items-center py-10 text-slate-400 dark:text-slate-600  hover:text-slate-800 dark:hover:text-slate-400"
            >
        ...
        <ul>
            <li
                class="w-full h-12 flex justify-center items-center py-6 text-slate-500 dark:text-slate-700  hover:text-slate-800 dark:hover:text-slate-400"
            >
            ...
            <li
                class="w-full h-12 flex justify-center items-center py-6 mb-3 text-slate-500 dark:text-slate-700  hover:text-slate-800 dark:hover:text-slate-400"
            >
