...
<template>
    <div class="flex w-full h-screen space-x-4 mt-2 px-2">
        <div class="space-y-4 py-2 w-52">
            <div>
                <h2 class="font-thin text-slate-400 mb-1">Common Inputs</h2>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <button class="dark:bg-slate-850 border dark:border-slate-800 p-2 rounded font-thin dark:text-slate-250 text-sm dark:hover:bg-slate-800 dark:hover:text-slate-200 disabled:opacity-50 disabled:cursor-not-allowed" :disabled="!crud.isForFilament() && !crud.isForNova()" @click="addRelationship('morphMany')">Morph Many</button>
                    <button class="dark:bg-slate-850 border dark:border-slate-800 p-2 rounded font-thin dark:text-slate-250 text-sm dark:hover:bg-slate-800 dark:hover:text-slate-200 disabled:opacity-50 disabled:cursor-not-allowed" :disabled="!crud.isForFilament() && !crud.isApi() && !crud.isForNova()" @click="addRelationship('belongsToMany')">Belongs To Many</button>
                    <button class="dark:bg-slate-850 border dark:border-slate-800 p-2 rounded font-thin dark:text-slate-250 text-sm dark:hover:bg-slate-800 dark:hover:text-slate-200 disabled:opacity-50 disabled:cursor-not-allowed" :disabled="!crud.isForFilament() && !crud.isForNova()" @click="addRelationship('morphToMany')">Morph To Many</button>
                </div>
            </div>
        </div>
