<script setup lang="ts">
    ...
    const filamentInputTypeIs = (type: string | string[]) => {
...
<template>
    <div class="p-4 space-y-4">
        ...
        <div v-if="filamentInputTypeIs('toggle')">
            <UiText v-model="input.filamentSettings.formData.onIcon" placeholder="On Icon" label="Icon when the toggle is active" @input="saveInput()" />
        </div>

        <div v-if="filamentInputTypeIs('toggle')">
            <UiText v-model="input.filamentSettings.formData.offIcon" placeholder="Off Icon" label="Icon when the toggle is not active" @input="saveInput()" />
        </div>
        ...
        <div v-if="filamentInputTypeIs(['file-upload', 'rich-editor', 'markdown-editor'])">
        ...
        <div v-if="filamentInputTypeIs('file-upload')">
        ...
        <div v-if="input.isTextarea()">
            <UiNumber :disabled="!filamentInputTypeIs('textarea')" v-model="input.filamentSettings.formData.rows" placeholder="Rows" label="Textarea Rows" @input="saveInput()" />
        </div>

        <div v-if="input.isTextarea()">
            <UiNumber :disabled="!filamentInputTypeIs('textarea')" v-model="input.filamentSettings.formData.cols" placeholder="Cols" label="Textarea Cols" @input="saveInput()" />
        </div>

        <div v-if="input.isTextarea()">
            <UiNumber :disabled="!filamentInputTypeIs('textarea')" v-model="input.filamentSettings.formData.exactLength" placeholder="Exact Length" label="Textarea Exact Length" @input="saveInput()" />
        </div>
        ...
        <div class="flex flex-col gap-2" v-if="filamentInputTypeIs(['text-input', 'datetime-picker', 'date-picker'])">
            ...
            <div class="flex-1 flex gap-2 items-center" v-for="(option, index) of input.filamentSettings.formData.dataList">
                <component :is="filamentInputTypeIs('text-input') ? UiText : UiDate" v-model="input.filamentSettings.formData.dataList[index]" @input="saveInput()" />
        ...
        <div class="flex flex-col gap-2" v-if="filamentInputTypeIs('file-upload') && input.filamentSettings.formData.useImageEditor">
        ...
        <div class="flex flex-col gap-2" v-if="filamentInputTypeIs(['rich-editor', 'markdown-editor'])">
        ...
        <div class="mt-2 flex gap-2 flex-col">
            ...
            <div class="flex gap-2 flex-col" v-if="filamentInputTypeIs('file-upload')">
            ...
            <div class="flex gap-2 flex-col" v-if="filamentInputTypeIs('select')">
            ...
            <div class="flex gap-2 flex-col" v-if="filamentInputTypeIs('color-picker')">
            ...
            <UiCheckbox v-if="input.type === InputType.BELONGS_TO && filamentInputTypeIs('select')" v-model="input.filamentSettings.formData.canBePreloaded" label="Preload relationship options" @input="saveInput()" />
            
            <UiCheckbox v-if="filamentInputTypeIs(['checkbox', 'toggle', 'radio'])" v-model="input.filamentSettings.formData.inline" label="Inline Component" @input="saveInput()" />
