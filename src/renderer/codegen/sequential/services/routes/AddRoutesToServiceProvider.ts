...
export default class AddRoutesToServiceProvider {
    async start(project: Project) {
        if(project.laravelVersionGreaterThan('10.0')) {
            console.log('Laravel version is greater than 10.0, skipping adding routes to service provider')
            return
        } 
