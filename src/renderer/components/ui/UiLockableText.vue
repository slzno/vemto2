...
<template>
    <div class="flex gap-1 flex-1" :class="{ 'flex-col': !inlineLabel, 'items-center': inlineLabel }">
        ...
        <div :class="{ 'flex-1': inlineLabel }" class="flex">
            <input
                ref="textInput"
                class="flex-1 border border-slate-650 border-r-transparent focus:border-red-500 dark:focus:border-red-500 focus:border-r-red-500 dark:focus:border-r-red-500 dark:focus:text-slate-200 dark:text-slate-300 focus:ring-transparent bg-slate-100 dark:bg-slate-950 px-2 py-1 rounded-lg rounded-r-none disabled:opacity-60 disabled:cursor-not-allowed"
                type="text"
                :id="id"
