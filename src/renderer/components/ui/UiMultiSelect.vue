    ...
    <div>
        ...
        <Multiselect
            ...
            :classes="{
                ...
                dropdown: 'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full border border-slate-300 dark:border-slate-650 -mt-px overflow-y-scroll z-50 bg-slate-950 flex flex-col rounded-b',
