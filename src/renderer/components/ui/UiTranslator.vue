...
<template>
    <div class="flex gap-1 flex-1" :class="{ 'flex-col': !inlineLabel, 'items-center': inlineLabel }">
        ...
        <div class="text-yellow-300">Translator</div>
        <div :class="{ 'flex-1': inlineLabel }" class="flex">
            <input
                ...
                :disabled="disabled"
            />
            <button class="flex px-2 items-center bg-slate-100 dark:bg-slate-950 border border-slate-650 border-l-0 rounded-lg rounded-l-none cursor-pointer hover:text-red-500">
